---
name: registry
description: Check if a UE5 material node type exists in the registry. Add missing node types. Use BEFORE generating YAML when you encounter an unfamiliar node type.
---
